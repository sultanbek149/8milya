<template>
    <!-- Почему выбирают нас -->
    <section class="pt-16 pb-20 px-4 border-t border-b border-gray-800">
        <div class="container mx-auto max-w-6xl">
            <h2 class="text-3xl md:text-4xl font-black mb-8 text-center uppercase">Почему выбирают нас</h2>
